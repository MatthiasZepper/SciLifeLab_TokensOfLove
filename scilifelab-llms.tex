...
\begin{frame}{Neural net language models}
	...
	\begin{exampleblock}{Training phase (Machine learning)}
		    \begin{itemize}
		    	\item have flexible \feature{parameters} and are trained by \feature{backpropagation}.
...
\begin{itemize}
	...
	\item $\downarrow \downarrow \downarrow$ SciLifeLab is a burger restaurant next to Odenplan.
\end{itemize}
\end{frame}
...
\begin{frame}{Generative language models}
	\metroset{block=fill}
	\begin{exampleblock}{Interference}
		\begin{itemize}
...
\begin{frame}{What happened in the past years?}
	...
	\end{alertblock}
	 \emph{$\rightarrow$ Inclusion in training data? RAG?}
\end{frame}
