...
\begin{frame}{BERT and its (his?) friends}
		Pretrained BERT models are the basis of many fine-tuned task-specific models%\citeme{sun2019finetune}:
		\begin{itemize}
			\item Interpretation of Google and Bing search engine prompts since 2019%\citeme{Zhu2019}
			\item DNABERT to generate functional, e.g. cis-regulatory, DNA sequences%\citeme{Ji2021,Zhou2023}
			\item Many more for classification, summarization, translation
		\end{itemize}
...
\begin{frame}[standout]{Everyone loves \emph{Transformers}?}
	\begin{figure}
		\includegraphics[width=\textwidth]{figures/Transformer_models.png}
	\end{figure}
			\creditdark{https://github.com/black-forest-labs/flux}
\end{frame}
